...
civ_list = [
    discord.SelectOption(label="France Catherine Magnificent",
                         emoji="<:FranceCatherineMagnificence:1065756603728547871>"),
    ...
    discord.SelectOption(label="Arabia Sultan",
